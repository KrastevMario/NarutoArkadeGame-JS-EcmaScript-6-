...
class ThreeTomoeSharingan extends Powerup {
    constructor(options) {
        ...
        super(Object.assign({
            ...
            valueBG: "Sharingan3Tomoe",
            valueEFF: "SharinganBG"
        }, options));
        ...
        this.bgSharingan = [];
        for (var i = 0; i <= 3; i++) {
            this.bgSharingan[i] = "images/Sharingan/sharingan" + i + ".gif";
        }
        ...
        //activate background (red image only)
        eff.arenaEffectBG.push(new Eff({
            imageSrc: "images/Sharingan/background.png",
        }));
    }
    update(time) {
        let that = this;
        eff.arenaEffectBG = eff.arenaEffectBG.Filter(function (B) {
            return (B.valueEFF != that.valueEFF);
        });
        ...
        eff.arenaEffectBG.push(new Eff({
            imageSrc: that.bgSharingan[that.sharinganBgCounter],
            valueEFF: "SharinganBG",
            x: 550,
            y: 70,
            h: 150,
